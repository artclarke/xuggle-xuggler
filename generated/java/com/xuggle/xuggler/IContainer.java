 ...
 */
  public IStream addCopiedStream(int id, IStreamCoder sourceCoder) {
    long cPtr = XugglerJNI.IContainer_addCopiedStream(swigCPtr, this, id, IStreamCoder.getCPtr(sourceCoder), sourceCoder);
    return (cPtr == 0) ? null : new IStream(cPtr, false);
  }

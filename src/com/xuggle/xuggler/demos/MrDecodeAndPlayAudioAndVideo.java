...
public class MrDecodeAndPlayAudioAndVideo implements MediaReader.IListener
{
  ...
  {
    // create a media read for processing video, stipulate that we want
    // BufferedImages to created in BGR 24bit color space
    ...
    // happens here.  action happens in onVideoPicture() and
    // onAudioSamples() methods which are called when complete video
    // pictures and audio sample sets are extracted from the media souce

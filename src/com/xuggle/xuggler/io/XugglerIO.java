...
/**
 * Allows Xuggler to read from and write to many different types of Java I/O
 * objects, plus custom {@link IURLProtocolHandler} objects.
 * 
 * <p>
 * Most of the time, IContainer hides this away from you, but in case you're
...
public class XugglerIO implements IURLProtocolHandlerFactory
{
   ...
   * @param url the unique string to use for the mapping.
   * @param handler the handler
   * @param unmapUrlOnOpen if true, when Xuggler opens the
   ...
   *        {@link IContainer} opens the registered URL. If true, you do not
